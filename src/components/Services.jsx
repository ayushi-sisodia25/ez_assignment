  ...
  const services = [
    {
      ...
      img: "Ez_Labs_Assignment/assets/service/FilmProduction.png",
      content: `
...
`,
    },
    {
      ...
      heading: "Branding",
      img: "Ez_Labs_Assignment/assets/service/Branding.png",
      content: `
...
`,
    },
    {
      ...
      img: "Ez_Labs_Assignment/assets/service/ArtCuration.png",
      content: `
        ...
        <div className="relative flex flex-col items-center justify-center w-full h-10/12 pt-[150px] laptop:pt-0">
          ...
          <div className="absolute inset-0 -z-10 hidden tablet:block">
            {[1, 2, 3, 4].map((num) => (
              <img
                key={num}
                src={`Ez_Labs_Assignment/assets/service/${activeService.id}/${num}.svg`}
                alt={`bg-${num}`}
                className={`absolute ${
                  num === 1
            ...
            <div className="absolute hidden laptop:flex bottom-20 right-5/12 translate-x-1/2 flex-col items-center">
              ...
              <img
                src={`Ez_Labs_Assignment/assets/service/Vector.svg`}
                alt="arrow"
              />
            </div>
          </div>
